...
const PRESET_FIELDS: Array<{ key: PresetFieldKey; labelKey: string }> = [
  ...
  { key: 'gender',     labelKey: 'builder.identification.preset.gender'     },
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">
          {t('builder.identification.presetFields')}
        </p>
      ...
      <div className="flex flex-col gap-1.5">
        <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">
          {t('builder.identification.customFields')}
        </p>
        ...
        {customFields.map((f) => (
          <div key={f.id} className="flex items-center gap-1.5">
            <input
              ...
              placeholder={t('builder.identification.fieldLabelPlaceholder')}
